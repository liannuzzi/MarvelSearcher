...
useEffect(() => {
    fetch("http://gateway.marvel.com/v1/public/characters?offset=5&limit=8&ts=1&apikey=798a820405391028076a4b49bc50f7f5&hash=ff9f3b6fdf656a1b6f8c8250040cfb6e")
    .then((res) => res.json())
    .then((data) => {
